...
function MealCard({ meal, action, onClick }) {
    ...
    if (action === "add") {
        return (
            <div className='rounded-2xl bg-white p-2 flex gap-3 shadow-lg shadow-gray-200 items-center' onClick={onClick}>
    ...
    return (
        <Link to={`/recipe-builder/${meal.id}`} className='rounded-2xl bg-white p-3 flex flex-col gap-2 shadow-lg shadow-gray-200' onClick={onClick}>
